...
import com.example.cloudnotes.di.component.DaggerFragmentComponent
import com.example.cloudnotes.di.component.FragmentComponent
...
abstract class BaseFragment<VM : BaseViewModel> : Fragment() {
    ...
    private fun buildFragmentComponent() =
        DaggerFragmentComponent
            .builder()
            .applicationComponent((context!!.applicationContext as CloudNotes).applicationComponent)
