package com.example.cloudnotes.ui.base
...
import com.example.cloudnotes.di.component.DaggerViewHolderComponent
import com.example.cloudnotes.di.component.ViewHolderComponent
import com.example.cloudnotes.di.module.ViewHolderModule
import com.example.cloudnotes.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as CloudNotes).applicationComponent)
